    ...
    <div className="container-fluid">
      <div>
        <NewsCard
          ...
          link={`/newcollection/${encodeURIComponent("ANGEL OR CRAZY")}`}
          image="/news1.png"
        />
        ...
        <NewsCard2
          ...
          link={`/newcollection/${encodeURIComponent("GOOD BOY GONE BAD")}`}
          image="/news2.png"
        />
        ...
        <NewsCard
          ...
          link={`/newcollection/${encodeURIComponent("This Is Eclipse")}`}
          image="/news3.png"
        />
      </div>
    </div>
